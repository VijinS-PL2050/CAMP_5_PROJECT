...
<body>
	...
	<div id="container">
		...
		<div class="navbar">
			<a href="${pageContext.request.contextPath}/role/showFormrole">ROLE
				FORM</a> <a
				href="${pageContext.request.contextPath}/Department/showFormdept">DEPARTMENT
				FORM</a> <a href="${pageContext.request.contextPath}/user/showFormuser">USER
				FORM</a> <a href="${pageContext.request.contextPath}/role/list">LIST
				ROLE</a> <a href="${pageContext.request.contextPath}/Department/list">LIST
				DEPARTMENT</a> <a
				href="${pageContext.request.contextPath}/doctordetails/list">LIST
				DOCTOR DETAILS</a> <a
